...
update_blimp=["PsiDot","VhDot","VvpDot"]
#update_blimp=["VhDot","VvpDot","phase"]
ulimits_blimp={"PsiDot":[10*math.pi/180.,14*math.pi/180.],"VhDot":[-5.,5.],"phase":[0,math.pi],"VvpDot":[-50.,50.]}
...
x_init += [0.0,-12.,-15., 0.0, 3.0, 0., 87*math.pi/180.,45*math.pi/180.,25.0,W["Cl"]]
x_init += [-12.0,0.,-15., -math.pi/2.0, 3.0, 0., 87*math.pi/180.,45*math.pi/180.,25.0,W["Cl"]]
    ...
    for t in range(0, N):
        ...
        for i in range(blimps):
            ...
            if (t<10):
                ...
                print("%f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f"%(x["blimp"][i]["Px"],x["blimp"][i]["Py"],x["blimp"][i]["Pz"],cv["x"],cv["y"],cv["z"],cp["x"],cp["y"],cp["z"],x["blimp"][i]["Vh"],Vv,a,U["blimp"][i]["PsiDot"]*180.0/math.pi))
                ...
                r0_exp=(shardlimits_blimp["Vh"][0]+2*windforce)/U["blimp"][i]["PsiDot"]
                rdot=math.sin(phi)*windforce
                rExp=r0_exp+math.cos(phi)*windforce/U["blimp"][i]["PsiDot"]
