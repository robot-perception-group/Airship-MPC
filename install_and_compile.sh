...
sudo apt-get install ros-noetic-ros-base gazebo11 ros-noetic-gazebo-dev ros-noetic-octomap-msgs ros-noetic-tf ros-noetic-mrpt2 ros-noetic-image-transport ros-noetic-rviz ros-noetic-cv-camera ros-noetic-image-geometry ros-noetic-gazebo-plugins ros-noetic-octomap-ros ros-noetic-controller-manager ros-noetic-joint-state-publisher ros-noetic-robot-state-publisher ros-noetic-xacro|| { echo "Failure"; exit;}
